...
export default async function ProjectsPage() {
	...
	const featured = allProjects.find((project) => project.slug === "nutrilist")!;
	const top2 = allProjects.find((project) => project.slug === "chemaware")!;
	const top3 = allProjects.find((project) => project.slug === "planetfall")!;
